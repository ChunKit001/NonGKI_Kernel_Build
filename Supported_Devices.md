...
| 小米 6 | sagit | 4.4/MiCode/sagit-p-oss | MIUI 9.9.3 | 9 | AnyKernel3 | SukiSU(U) v3.1.5 | ❌ | ✅ | ❌ | ❌ | ❌ | Beta |  
...
特别说明：
  ...
  - 小米 6 基于官方 MiCode `sagit-p-oss`（Android P / MIUI 9.9.3）。因 Android 9 无法运行 SukiSU 4.x 管理器（`setNavigationBarContrastEnforced` 需 API 29），内核与管理器均固定为 **SukiSU-Ultra v3.1.5**；启用实验性 LXC；SuSFS/KPM 未开

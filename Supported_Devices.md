...
| 小米 6 | sagit | 4.4/MiCode/sagit-p-oss | MIUI 9.9.3 | 9 | AnyKernel3 | v0.9.5 | ❌ | ✅ | ❌ | ❌ | ❌ | Beta |  
...
特别说明：
  ...
  - 小米 6 基于官方 MiCode `sagit-p-oss`（Android P / MIUI 9.9.3）。KernelSU 钉死官方 [v0.9.5](https://github.com/tiann/KernelSU/releases/tag/v0.9.5)（最后支持 non-GKI 的版本）；请安装同版本管理器 `KernelSU_v0.9.5_11872-release.apk`，不要装 rsuntk / SukiSU Ultra。启用实验性 LXC；SuSFS/KPM 未开

...
| 小米 6 | sagit | 4.4/MiCode/sagit-p-oss | MIUI 9.9.3 | 9 | AnyKernel3 | SukiSU(U) | ❌ | ✅ | ❌ | ❌ | ❌ | Beta |  
...
特别说明：
  ...
  - 小米 6 基于官方 MiCode `sagit-p-oss`（Android P / MIUI 9.9.3 对应内核），KernelSU 使用 SukiSU-Ultra；启用实验性 LXC。4.4 不保证 SuSFS/KPM 可用，故均未开启

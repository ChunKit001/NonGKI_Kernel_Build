## 项目更新日志
- **Ver.1.4 Fixed 32**
    - 修补 小米6 (sagit) v0.9.5 `core_hook.c`：prctl 的 arg3/arg4 是 unsigned long，传给 `copy_to_user`/`copy_from_user` 需转为 `void __user *`
...
- **Ver.1.4 Fixed 25**
    ...
    - 因 Android 9 无法运行 4.1.1 及更新管理器，将该设备固定为能用的最新版 SukiSU-Ultra v4.1.0
    - 增加 支持列表 对应说明
